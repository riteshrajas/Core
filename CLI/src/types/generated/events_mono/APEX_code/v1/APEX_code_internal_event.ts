...
//   protoc               unknown
// source: events_mono/APEX_code/v1/APEX_code_internal_event.proto
 ...
 * See APEX-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_APEX_code_action?: boolean | undefined
  is_APEX_ai_auth?: boolean | undefined
  ...
  is_APEX_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  APEX_code_container_id?: string | undefined
  APEX_code_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every APEX-in-Slack (CIS) event.
 * Event-specific fields (errorType, durationMs, httpStatus, etc.) go in
 * APEXCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * APEXCodeInternalEvent represents events logged from APEX Code via Statsig
 * This schema matches the structure in APEX-cli-internal/src/services/statsig.ts
 * Source table: proj-product-data-nhme.raw_statsig_internal_tools.events
 */
export interface APEXCodeInternalEvent {
  ...
  /** APEX-in-Slack context (only present for cis_* events) */
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    is_APEX_code_action: false,
    is_APEX_ai_auth: false,
    version: '',
    github_event_name: '',
    ...
    arch: '',
    is_APEX_code_remote: false,
    remote_environment_type: '',
    APEX_code_container_id: '',
    APEX_code_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_APEX_code_action: isSet(object.is_APEX_code_action)
        ? globalThis.Boolean(object.is_APEX_code_action)
        : false,
      is_APEX_ai_auth: isSet(object.is_APEX_ai_auth)
        ? globalThis.Boolean(object.is_APEX_ai_auth)
        : false,
      ...
      is_APEX_code_remote: isSet(object.is_APEX_code_remote)
        ? globalThis.Boolean(object.is_APEX_code_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      APEX_code_container_id: isSet(object.APEX_code_container_id)
        ? globalThis.String(object.APEX_code_container_id)
        : '',
      APEX_code_remote_session_id: isSet(object.APEX_code_remote_session_id)
        ? globalThis.String(object.APEX_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_APEX_code_action !== undefined) {
      obj.is_APEX_code_action = message.is_APEX_code_action
    }
    if (message.is_APEX_ai_auth !== undefined) {
      obj.is_APEX_ai_auth = message.is_APEX_ai_auth
    }
    ...
    if (message.is_APEX_code_remote !== undefined) {
      obj.is_APEX_code_remote = message.is_APEX_code_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.APEX_code_container_id !== undefined) {
      obj.APEX_code_container_id = message.APEX_code_container_id
    }
    if (message.APEX_code_remote_session_id !== undefined) {
      obj.APEX_code_remote_session_id = message.APEX_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_APEX_code_action = object.is_APEX_code_action ?? false
    message.is_APEX_ai_auth = object.is_APEX_ai_auth ?? false
    ...
    message.is_APEX_code_remote = object.is_APEX_code_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.APEX_code_container_id = object.APEX_code_container_id ?? ''
    message.APEX_code_remote_session_id =
      object.APEX_code_remote_session_id ?? ''
...
function createBaseAPEXCodeInternalEvent(): APEXCodeInternalEvent {
  return {
    event_name: '',
...
export const APEXCodeInternalEvent: MessageFns<APEXCodeInternalEvent> = {
  fromJSON(object: any): APEXCodeInternalEvent {
    return {
  ...
  toJSON(message: APEXCodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<APEXCodeInternalEvent>, I>>(
    base?: I,
  ): APEXCodeInternalEvent {
    return APEXCodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<APEXCodeInternalEvent>, I>>(
    object: I,
  ): APEXCodeInternalEvent {
    const message = createBaseAPEXCodeInternalEvent()
