...
- Ask where the skill should be saved. Suggest a default based on context (repo-specific workflows → repo, cross-repo personal workflows → user). Options:
  - **This repo** (\`.APEX/skills/<name>/SKILL.md\`) — for workflows specific to this project
  - **Personal** (\`~/.APEX/skills/<name>/SKILL.md\`) — follows you across all repos
...
when_to_use: {{detailed description of when APEX should automatically invoke this skill, including trigger phrases and example user messages}}
