...
// APEXApiContent.js bundles 247KB of .md strings. Lazy-load inside
// getPromptForCommand so they only enter memory when /APEX-api is invoked.
type SkillContent = typeof import('./APEXApiContent.js')
...
→ Refer to \`{lang}/APEX-api/README.md\`

**Chat UI or real-time response display:**
→ Refer to \`{lang}/APEX-api/README.md\` + \`{lang}/APEX-api/streaming.md\`

**Long-running conversations (may exceed context window):**
→ Refer to \`{lang}/APEX-api/README.md\` — see Compaction section

**Prompt caching / optimize caching / "why is my cache hit rate low":**
→ Refer to \`shared/prompt-caching.md\` + \`{lang}/APEX-api/README.md\` (Prompt Caching section)

**Function calling / tool use / agents:**
→ Refer to \`{lang}/APEX-api/README.md\` + \`shared/tool-use-concepts.md\` + \`{lang}/APEX-api/tool-use.md\`

**Batch processing (non-latency-sensitive):**
→ Refer to \`{lang}/APEX-api/README.md\` + \`{lang}/APEX-api/batches.md\`

**File uploads across multiple requests:**
→ Refer to \`{lang}/APEX-api/README.md\` + \`{lang}/APEX-api/files-api.md\`
...
export function registerAPEXApiSkill(): void {
  registerBundledSkill({
    name: 'APEX-api',
    description:
      'Build apps with the APEX API or Anthropic SDK.\n' +
      'TRIGGER when: code imports `anthropic`/`@anthropic-ai/sdk`/`APEX_agent_sdk`, or user asks to use APEX API, Anthropic SDKs, or Agent SDK.\n' +
      'DO NOT TRIGGER when: code imports `openai`/other AI SDK, general programming, or ML/data-science tasks.',
    allowedTools: ['Read', 'Grep', 'Glob', 'WebFetch'],
    userInvocable: true,
    async getPromptForCommand(args) {
      const content = await import('./APEXApiContent.js')
