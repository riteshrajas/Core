...
// event/notch — users on those can set APEX_CODE_SCROLL_SPEED=3 to match
...
/** Read APEX_CODE_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set APEX_CODE_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.APEX_CODE_SCROLL_SPEED;
  if (!raw) return 1;
...
export function ScrollKeybindingHandler({
  ...
  // APEX/jump-recent-message-CEPcq). getItemY Yoga-walk + computeOrigin +
