...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between APEX models. Applies to this session and future APEX Code sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
