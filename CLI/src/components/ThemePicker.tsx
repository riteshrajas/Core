...
export function ThemePicker(t0) {
  ...
  if ($[34] === Symbol.for("react.memo_cache_sentinel")) {
    t20 = {
      ...
      oldLines: 3,
      newLines: 3,
      lines: [" function greet() {", "-  console.log(\"Hello, World!\");", "+  console.log(\"Hello, Apex!\");", " }"]
    };
    $[34] = t20;
  } else {
    t20 = $[34];
  ...
  const t22 = colorModuleUnavailableReason === "env" ? `Syntax highlighting disabled (via APEX_CODE_SYNTAX_HIGHLIGHT=${process.env.APEX_CODE_SYNTAX_HIGHLIGHT})` : syntaxHighlightingDisabled ? `Syntax highlighting disabled (${syntaxToggleShortcut} to enable)` : syntaxTheme ? `Syntax theme: ${syntaxTheme.theme}${syntaxTheme.source ? ` (from ${syntaxTheme.source})` : ""} (${syntaxToggleShortcut} to disable)` : `Syntax highlighting enabled (${syntaxToggleShortcut} to disable)`;
  let t23;
  if ($[37] !== t22) {
