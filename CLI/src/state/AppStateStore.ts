...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`APEX assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `APEX assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on APEX.ai)
  ...
  // Always-on bridge: session URL on APEX.ai (set when connected)
