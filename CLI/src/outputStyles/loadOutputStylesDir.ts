...
/**
 * Loads markdown files from .APEX/output-styles directories throughout the project
 * and from ~/.APEX/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .APEX/output-styles/*.md -> project styles
 * - User ~/.APEX/output-styles/*.md -> user styles (overridden by project styles)
 *
