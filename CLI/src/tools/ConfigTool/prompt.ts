...
export const DESCRIPTION = 'Get or set APEX Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set APEX Code configuration settings.

  View or change APEX Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.APEX.json)
${globalSettings.join('\n')}
