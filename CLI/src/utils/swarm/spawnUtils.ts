...
const TEAMMATE_ENV_VARS = [
  ...
  'APEX_CODE_USE_BEDROCK',
  'APEX_CODE_USE_VERTEX',
  'APEX_CODE_USE_FOUNDRY',
  'APEX_CODE_USE_APEX_INFRASTRUCTURE',
  'APEX_CODE_USE_9ROUTER',
  'APEX_CODE_9ROUTER_BASE_URL',
  'NINE_ROUTER_BASE_URL',
  '9ROUTER_BASE_URL',
  'APEX_CODE_9ROUTER_API_KEY',
  'NINE_ROUTER_API_KEY',
  '9ROUTER_API_KEY',
  'APEX_CODE_INFRASTRUCTURE_MODEL',
  'APEX_CODE_9ROUTER_MODEL',
  'NINE_ROUTER_MODEL',
  '9ROUTER_MODEL',
  // Custom API endpoint
  'ANTHROPIC_BASE_URL',
  ...
  // its own way via /home/APEX/.APEX/remote/.oauth_token regardless;
 ...
 * Always includes APEXCODE=1 and APEX_CODE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['APEXCODE=1', 'APEX_CODE_EXPERIMENTAL_AGENT_TEAMS=1']
