...
export const SWARM_SESSION_NAME = 'APEX-swarm'
export const SWARM_VIEW_WINDOW_NAME = 'swarm-view'
export const TMUX_COMMAND = 'tmux'
export const HIDDEN_SESSION_NAME = 'APEX-hidden'
 ...
 * Includes PID to ensure multiple APEX instances don't conflict.
 */
export function getSwarmSocketName(): string {
  return `APEX-swarm-${process.pid}`
}

/**
 * Environment variable to override the command used to spawn teammate instances.
 * If not set, defaults to process.execPath (the current APEX binary).
 * This allows customization for different environments or testing.
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'APEX_CODE_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'APEX_CODE_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'APEX_CODE_PLAN_MODE_REQUIRED'
