...
/**
 * Captured at module load time to detect if the user started APEX from within tmux.
 ...
 * because Shell.ts overrides TMUX when APEX's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started APEX from within their tmux session
