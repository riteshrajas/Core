// Scheduled prompts, stored in <project>/.APEX/scheduled_tasks.json.
//
...
const CRON_FILE_REL = join('.APEX', 'scheduled_tasks.json')
...
/**
 * Read and parse .APEX/scheduled_tasks.json. Returns an empty task list if the file
...
/**
 * Overwrite .APEX/scheduled_tasks.json with the given tasks. Creates .APEX/ if
 ...
 * written to .APEX/scheduled_tasks.json and dies with the process. The
 ...
 * and recurring tasks — a recurring task whose window passed while APEX
