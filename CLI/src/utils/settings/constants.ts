...
/**
 * The JSON Schema URL for APEX Code settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/APEX-code-settings.json
 */
export const APEX_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/APEX-code-settings.json'
