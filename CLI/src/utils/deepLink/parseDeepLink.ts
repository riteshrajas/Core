 ...
 *
 * Parses `APEX-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   APEX-cli://open
 *   APEX-cli://open?q=hello+world
 *   APEX-cli://open?q=fix+tests&repo=owner/repo
 *   APEX-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'APEX-cli'
 ...
 * the `cd /d <cwd> && <APEX.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a APEX-cli:// URI into a structured action.
 *
...
/**
 * Build a APEX-cli:// deep link URL.
 */
