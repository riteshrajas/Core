 ...
 * variables instead: APEX_CODE_AGENT_ID, APEX_CODE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from APEX_CODE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
