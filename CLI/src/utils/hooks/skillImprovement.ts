...
import { queryModelWithoutStreaming } from '../../services/api/APEX.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .APEX/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.APEX', 'skills', skillName, 'SKILL.md')
