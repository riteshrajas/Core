...
function getCacheDir(): string {
  return join(getAPEXConfigHomeDir(), 'cache')
}
...
// Keyed on cache path so tests that set APEX_CONFIG_DIR get a fresh read
...
export async function refreshModelCapabilities(): Promise<void> {
  ...
  try {
    ...
    const betas = isAPEXAISubscriber() ? [OAUTH_BETA_HEADER] : undefined
