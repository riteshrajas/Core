...
import { getAdditionalDirectoriesForAPEXMd } from '../../bootstrap/state.js'
import {
...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.APEX/skills)
  ...
  // User commands directory (~/.APEX/commands)
  ...
  // Project skills directory (.APEX/skills)
  ...
  // Project commands directory (.APEX/commands)
  ...
  for (const dir of getAdditionalDirectoriesForAPEXMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.APEX', 'skills')
    try {
