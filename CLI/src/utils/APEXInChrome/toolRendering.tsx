...
import { trackAPEXInChromeTabId } from './common.js';
export type { Tool } from '@modelcontextprotocol/sdk/types.js';

/**
 * All tool names from BROWSER_TOOLS in @ant/APEX-for-chrome-mcp.
...
/**
 * Renders a clickable "View Tab" link for APEX in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a APEX in Chrome MCP tool
...
/**
 * Custom tool result message rendering for APEX-in-chrome tools.
...
/**
 * Returns tool method overrides for APEX in Chrome MCP tools. Use this to customize
 * rendering for chrome tools in a single spread operation.
 */
export function getAPEXInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `APEX in Chrome[${displayName}]`;
    },
