 ...
 * /home/APEX/.APEX/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/APEX/.APEX/remote'
 ...
 * access. CCR-gated: outside CCR there's no /home/APEX/ and no reason to
 ...
 * rationale. Env var: APEX_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/APEX/.APEX/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'APEX_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: APEX_CODE_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/APEX/.APEX/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'APEX_CODE_API_KEY_FILE_DESCRIPTOR',
