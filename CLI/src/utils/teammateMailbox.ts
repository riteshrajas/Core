 ...
 *
 * Each teammate has an inbox file at .APEX/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.APEX/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to APEX_CODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's APEX_CODE_AGENT_ID */
  workerId: string
  /** Worker's APEX_CODE_AGENT_NAME */
  workerName: string
  /** Worker's APEX_CODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to APEX_CODE_TEAM_NAME env var)
