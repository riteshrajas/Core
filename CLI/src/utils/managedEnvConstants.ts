 ...
 *
 * When APEX_CODE_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
 * are stripped from settings-sourced env so the host's routing config isn't
 * overridden by a user's ~/.APEX/settings.json — e.g. a Bedrock setup for
 ...
 * VERTEX_REGION_APEX_* is prefix-matched. New providers or new routing
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'APEX_CODE_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  ...
  // Region routing (per-model VERTEX_REGION_APEX_* handled by prefix below)
  'CLOUD_ML_REGION',
  // Auth
  'ANTHROPIC_API_KEY',
  ...
  'APEX_CODE_SKIP_BEDROCK_AUTH',
  'APEX_CODE_SKIP_VERTEX_AUTH',
  'APEX_CODE_SKIP_FOUNDRY_AUTH',
 ...
 * These are APEX Code specific settings that don't pose security risks.
 *
 ...
 * - ANTHROPIC_BASE_URL, APEX_CODE_9ROUTER_BASE_URL, ANTHROPIC_BEDROCK_BASE_URL, ANTHROPIC_FOUNDRY_BASE_URL, ANTHROPIC_VERTEX_BASE_URL
...
export const SAFE_ENV_VARS = new Set([
  ...
  'BASH_MAX_TIMEOUT_MS',
  'APEX_BASH_MAINTAIN_PROJECT_WORKING_DIR',
  'APEX_CODE_API_KEY_HELPER_TTL_MS',
  'APEX_CODE_DISABLE_EXPERIMENTAL_BETAS',
  'APEX_CODE_DISABLE_NONESSENTIAL_TRAFFIC',
  'APEX_CODE_DISABLE_TERMINAL_TITLE',
  'APEX_CODE_ENABLE_TELEMETRY',
  'APEX_CODE_EXPERIMENTAL_AGENT_TEAMS',
  'APEX_CODE_IDE_SKIP_AUTO_INSTALL',
  ...
  'USE_BUILTIN_RIPGREP',
  'VERTEX_REGION_APEX_3_5_HAIKU',
  'VERTEX_REGION_APEX_3_5_SONNET',
  'VERTEX_REGION_APEX_3_7_SONNET',
  'VERTEX_REGION_APEX_4_0_OPUS',
  'VERTEX_REGION_APEX_4_0_SONNET',
  'VERTEX_REGION_APEX_4_1_OPUS',
  'VERTEX_REGION_APEX_4_5_SONNET',
  'VERTEX_REGION_APEX_4_6_SONNET',
  'VERTEX_REGION_APEX_HAIKU_4_5',
])
