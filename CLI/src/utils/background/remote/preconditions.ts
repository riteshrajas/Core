...
/**
 * Checks if user needs to log in with APEX.ai
 * Extracted from getTeleportErrors() in TeleportError.tsx
 * @returns true if login is required, false otherwise
 */
export async function checkNeedsAPEXAiLogin(): Promise<boolean> {
 ...
 * @param repo The repository name (e.g., "APEX-cli-internal")
