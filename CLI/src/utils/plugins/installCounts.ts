 ...
 * APEX plugins statistics repository. The cache is refreshed if older
 * than 24 hours.
 *
 * Cache location: ~/.APEX/plugins/install-counts-cache.json
 */
...
const INSTALL_COUNTS_URL =
  'https://raw.githubusercontent.com/anthropics/APEX-plugins-official/refs/heads/stats/stats/plugin-installs.json'
