...
function createPluginCommand(
  ...
  try {
    ...
    // Substitute ${APEX_PLUGIN_ROOT} in allowed-tools before parsing
    ...
    return {
      ...
      async getPromptForCommand(args, context) {
        ...
        // Replace ${APEX_PLUGIN_ROOT} and ${APEX_PLUGIN_DATA} with their paths
        ...
        // Replace ${APEX_SKILL_DIR} with this specific skill's directory.
        // Distinct from ${APEX_PLUGIN_ROOT}: a plugin can contain multiple
        // skills, so APEX_PLUGIN_ROOT points to the plugin root while
        // APEX_SKILL_DIR points to the individual skill's subdirectory.
