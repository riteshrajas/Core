 ...
 *
 * These helpers identify whether this APEX Code instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.APEX_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our APEX_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no APEX_CODE_AGENT_ID set (backwards compat: the original
