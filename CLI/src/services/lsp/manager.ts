 ...
 * Initialized during APEX Code startup.
 */
 ...
 * asynchronously during APEX Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during APEX Code startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/APEX-code/issues/15521:
 ...
 *
 * This should be called during APEX Code shutdown. Stops all running LSP servers
