...
/**
 * Map LSP severity to APEX diagnostic severity
 *
 * Maps LSP severity numbers to APEX diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to APEX diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by APEX's attachment system.
 */
 ...
 * from all LSP servers and routes them to APEX's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to APEX format (can throw on invalid URIs)
