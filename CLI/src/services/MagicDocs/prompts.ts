...
- Information already in APEX.md or other project docs
 ...
 * Custom prompts can be placed at ~/.APEX/magic-docs/prompt.md
...
async function loadMagicDocsPrompt(): Promise<string> {
  ...
  const promptPath = join(getAPEXConfigHomeDir(), 'magic-docs', 'prompt.md')
