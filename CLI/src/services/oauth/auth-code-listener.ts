...
import { shouldUseAPEXAIAuth } from './client.js'
...
export class AuthCodeListener {
  ...
  handleSuccessRedirect(
    ...
    const successUrl = shouldUseAPEXAIAuth(scopes)
      ? getOauthConfig().APEXAI_SUCCESS_URL
  ...
  handleErrorRedirect(): void {
    ...
    const errorUrl = getOauthConfig().APEXAI_SUCCESS_URL
