...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so APEX.ai sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so APEX.ai doesn't show
