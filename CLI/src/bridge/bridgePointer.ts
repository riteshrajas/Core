 ...
 * persists. On next startup, `APEX remote-control` detects it and offers
 ...
 * and handles errors — no existence check (APEX.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `APEX remote-control --continue` runs
