 ...
 * clone/push in APEX.ai/code works immediately after this succeeds.
 */
...
/** Returns true when the user has valid APEX OAuth credentials. */
...
export function getCodeWebUrl(): string {
  return `${getOauthConfig().APEX_AI_ORIGIN}/code`
}
