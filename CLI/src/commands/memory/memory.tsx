...
import { clearMemoryFileCaches, getMemoryFiles } from '../../utils/APEXmd.js';
...
function MemoryCommand({
  ...
  const handleSelectMemoryFile = async (memoryPath: string) => {
    try {
      // Create APEX directory if it doesn't exist (idempotent with recursive)
      if (memoryPath.includes(getAPEXConfigHomeDir())) {
        await mkdir(getAPEXConfigHomeDir(), {
          recursive: true
        });
      }
  ...
  return <Dialog title="Memory" onCancel={handleCancel} color="remember">
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text dimColor>
            Learn more: <Link url="https://code.APEX.com/docs/en/memory" />
          </Text>
        </Box>
      </Box>
    </Dialog>;
