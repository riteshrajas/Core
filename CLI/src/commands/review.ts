...
// user triggers, so the description carries "APEX Code on the web" + URL.
const CCR_TERMS_URL = 'https://code.claude.com/docs/en/APEX-code-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in APEX Code on the web. See ${CCR_TERMS_URL}`,
