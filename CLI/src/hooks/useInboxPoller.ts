 ...
 * - Process-based teammates use their APEX_CODE_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for APEX (include color if available)
    // Transform plan approval requests to include instructions for APEX
