...
/**
 * Gets additional files from APEX config directories
 */
async function getAPEXConfigFiles(cwd: string): Promise<string[]> {
  const markdownFileArrays = await Promise.all(
    APEX_CONFIG_DIRECTORIES.map(subdir =>
