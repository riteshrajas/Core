 ...
 *
 * This instruction provides guidance for APEX's behavior when handling
 ...
 *   - How APEX handles penetration testing and CTF requests
 *   - What security tools and techniques APEX will assist with
 ...
 *
 * APEX: Do not edit this file unless explicitly asked to do so by the user.
 */
